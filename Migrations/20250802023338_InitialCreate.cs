    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReadingSpots", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "BookDepartments",
                columns: table => new
                {
                    RelatedBooksId = table.Column<int>(type: "int", nullable: false),
                    RelatedDepartmentsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookDepartments", x => new { x.RelatedBooksId, x.RelatedDepartmentsId });
                    table.ForeignKey(
                        name: "FK_BookDepartments_Books_RelatedBooksId",
                        column: x => x.RelatedBooksId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookDepartments_Departments_RelatedDepartmentsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookEvents", x => new { x.EventsId, x.RelatedBooksId });
                    table.ForeignKey(
                        name: "FK_BookEvents_Books_RelatedBooksId",
                        column: x => x.RelatedBooksId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookEvents_Events_EventsId",
                        column: x => x.EventsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookProducts", x => new { x.RelatedBooksId, x.RelatedProductsId });
                    table.ForeignKey(
                        name: "FK_BookProducts_Books_RelatedBooksId",
                        column: x => x.RelatedBooksId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookProducts_Products_RelatedProductsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookDepartments_RelatedDepartmentsId",
                table: "BookDepartments",
                column: "RelatedDepartmentsId");

            migrationBuilder.CreateIndex(
                name: "IX_BookEvents_RelatedBooksId",
                table: "BookEvents",
                column: "RelatedBooksId");

            migrationBuilder.CreateIndex(
                name: "IX_BookProducts_RelatedProductsId",
                table: "BookProducts",
